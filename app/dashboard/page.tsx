                      ...
                      {isEditingStats ? (
                        ...
                        <>
                          ...
                          <p className="text-xs text-purple-600">
                            {utiStats.infections.bloodstream.rate}% dos pacientes
                          </p>
                        </>
                      )}
                    </div>
                      ...
                      {isEditingStats ? (
                        ...
                        <>
                          <p className="text-lg font-bold text-slate-900">
                            {utiStats.qualityIndicators.ventilatorDays}
                          </p>
                          <p className="text-xs text-slate-600">Ventilador-dias no mês</p>
                        </>
                      )}
                ...
                <div className="space-y-3 text-sm text-slate-700">
                  ...
                  <div className="p-3 bg-blue-50 border border-blue-200 rounded">
                    <p className="text-xs text-blue-800">
                      Esta ação foi registrada no sistema de auditoria em conformidade com a LGPD (Lei 13.709/2018).
                      Todas as alterações em dados sensíveis são monitoradas e podem ser auditadas.
                    </p>
                  </div>
                </div>
